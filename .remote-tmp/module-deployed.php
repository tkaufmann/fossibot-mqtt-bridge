...
class FossibotLocalControl extends IPSModule
{
    ...
    private const MQTT_SERVER_INSTANCE_ID = 53258;
    ...
    /**
     * Phase 4: Get CommandQueue instance.
     * Queue uses $this->GetBuffer/SetBuffer for persistence.
     */
    private function getQueue(): CommandQueue
    {
        ...
        return new CommandQueue(
            ...
            self::DEVICE_MAC,
            $this->InstanceID,
            fn($key) => $this->GetBuffer($key),
            fn($key, $val) => $this->SetBuffer($key, $val)
        );
    }
